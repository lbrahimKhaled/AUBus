...
->to run the project server navigate to the readme of connections folder and follow the steps
->to run the project client side navigate to the readme of the frontend and follow the steps
